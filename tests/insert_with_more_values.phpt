...
$insert_values = [10,1010110,10, 'test'];
...
var_dump($insert_values[2] == $inserted_values[0][2]);

?>
--EXPECTF--
Warning: HandlerSocketi_Index::insert(): invalid field count in %s on line %d
bool(true)
bool(true)
bool(true)
