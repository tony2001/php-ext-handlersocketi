...
$index = $hs->openIndex('test_test_test', 'HandlerSocketTestTbl', array('user_id', 'ts', 'data'),$open_options);
?>
--EXPECTF--
...
Stack trace:
#0 %s(%d): HandlerSocketi->openIndex('test_test_test', 'HandlerSocketTe...', Array, Array)
#1 {main}
